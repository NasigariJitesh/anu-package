...
const StepIndicatorExample = () => {
  ...
  return (
    <ScrollView horizontal style={{ flex: 1, width: '100%' }}>
      <StepIndicator width={580} style={{ marginVertical: 15 }}>
...
const StepIndicatorExample1 = () => {
  const { next, previous } = useStepIndicatorContext();

  const [completed, setCompleted] = useState<boolean[]>([false, false, false, false]);
  return (
    <Container style={{ flex: 1, width: '100%' }}>
      <StepIndicator width={300} labelPlacement='below' style={{ marginVertical: 15 }}>
        <Step style={{ padding: 10, width: '100%' }} completed={completed[0]}>
          <Typography.Title> Step 1</Typography.Title>
...
const StepIndicatorExample2 = () => {
  const { next, previous } = useStepIndicatorContext();

  const [completed, setCompleted] = useState<boolean[]>([false, false, false, false]);
  return (
    <Container style={{ flex: 1, width: '100%' }}>
      <StepIndicator vertical style={{ marginVertical: 15, height: 500 }}>
        <Step style={{ padding: 10, width: '100%' }} completed={completed[0]}>
          <Typography.Title> Step 1</Typography.Title>
...
const StepIndicatorScreen = () => {
  return (
    <ScrollView style={{ flex: 1 }}>
      ...
      <StepIndicatorProvider totalSteps={4}>
        <StepIndicatorExample1 />
      </StepIndicatorProvider>
      <StepIndicatorProvider totalSteps={4}>
        <StepIndicatorExample2 />
      </StepIndicatorProvider>
    </ScrollView>
  );
};
