  ...
  return (
    <Container disableGutters sx={flexStyle as never}>
      <StepIndicator style={style} labelPlacement='below'>
        <Step style={{ padding: 10, width: '100%' }} completed={completed[0]} editable>
        ...
        <Step style={{ padding: 10, width: '100%' }} completed={completed[1]} name='Custom name'>
        ...
        <Step style={{ padding: 10, width: '100%' }} completed={completed[2]} error={completed[2]}>
        ...
        <Step style={{ padding: 10, width: '100%' }} completed={completed[3]} optional>
        ...
        <Step style={{ padding: 10, width: '100%' }} completed={completed[4]} notApplicable={completed[1]}>
        ...
        <Step style={{ padding: 10, width: '100%' }} completed={completed[5]} optional optionalLabel={'Not Mandatory'}>
        ...
        <Step icon={<Icon name='person' />} style={{ padding: 10, width: '100%' }} completed={completed[6]}>
