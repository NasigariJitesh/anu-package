...
import { compressFileNative, getErrorMessageStyle, getFileUploadStyle } from '../../utils';
 ...
 */
const FileUpload = forwardRef<FileUploadReferenceProps, NativeFileUploadProps>((props, reference) => {
  //@ts-expect-error
