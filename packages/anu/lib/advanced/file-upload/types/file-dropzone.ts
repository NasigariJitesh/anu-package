...
import { Config, ConfigNative } from './file-upload';
...
interface ImageFileDropZoneCommonProps extends BasicFileDropZoneProps {
  uploadVariant?: 'image';
  /**
...
type ImageFileDropZoneProps = ImageFileDropZoneCommonProps & {
  optimizationConfig?: Config;
};

type NativeImageFileDropZoneProps = ImageFileDropZoneCommonProps & {
...
export type NativeFileDropZoneProps = NativeImageFileDropZoneProps | OtherFileDropZoneProps;
